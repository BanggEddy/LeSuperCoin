...
class getAnnoncesControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Controller/AnnoncesController.php';

        $container->services['App\\Controller\\AnnoncesController'] = $instance = new \App\Controller\AnnoncesController();

        $instance->setContainer(($container->privates['.service_locator.O2p6Lk7'] ?? $container->load('get_ServiceLocator_O2p6Lk7Service'))->withContext('App\\Controller\\AnnoncesController', $container));
