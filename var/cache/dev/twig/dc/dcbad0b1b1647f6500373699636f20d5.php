...
class __TwigTemplate_f29ce5edfb128bd8dbea991c0952ca05 extends Template
{
    ...
    ";
        ...
        ";
        // line 11
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 11, $this->source); })()), "no", [], "any", false, false, false, 11), 'row');
        echo "
        ";
        // line 12
...
{% endblock %}
", "registration/register.html.twig", "/var/www/html/LeSuperCoin/templates/registration/register.html.twig");
    }
}
