...
class __TwigTemplate_c93988033006bda1c7b063b9a75bc071 extends Template
{
    ...
    <input type=\"text\" value=\"";
        ...
        echo "\" name=\"no\" id=\"inputNo\" class=\"form-control\" autocomplete=\"username\" required autofocus>
...
<form method=\"post\">
    ...
    <h1 class=\"h3 mb-3 font-weight-normal\">Please sign in</h1>
    <label for=\"inputNo\">No</label>
    <input type=\"text\" value=\"{{ last_username }}\" name=\"no\" id=\"inputNo\" class=\"form-control\" autocomplete=\"username\" required autofocus>
    <label for=\"inputPassword\">Password</label>
    <input type=\"password\" name=\"password\" id=\"inputPassword\" class=\"form-control\" autocomplete=\"current-password\" required>
...
{% endblock %}
", "security/login.html.twig", "/var/www/html/lesupercoindavidli/templates/security/login.html.twig");
    }
}
